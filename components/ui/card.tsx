...
function Card({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      data-slot="card"
      className={cn(
        "bg-card text-card-foreground flex flex-col gap-6 rounded-2xl border py-8 px-6 shadow-lg transition-all duration-300 ease-in-out hover:shadow-2xl hover:scale-[1.02]",
        className
      )}
      {...props}
    />
